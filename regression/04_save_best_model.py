...
def main() -> None:
    ...
    print(
        ...
        "Among the linear family (SGD / OLS / Ridge), regularization and closed-form "
        "solutions are competitive, but the non-linear RandomForest typically captures "
        "interactions (e.g. experience × region × role family) that a purely linear "
        "assumption leaves on the table — so if RF leads on test R^2 without a huge "
        "train/test gap, it is the right production choice for the salary predictor."
