...
Wraps linear_regression/pipeline.predict_salary and exposes /predict + /retrain.
"""
...
# Make linear_regression/ importable so we reuse the same pipeline as Part 1.
REPO_ROOT = Path(__file__).resolve().parent.parent
REGRESSION_DIR = REPO_ROOT / "linear_regression"
